...
/***/ function(module, exports) {
	...
	var KeywordsClient = function () {
	    function KeywordsClient() {
	        _classCallCheck(this, KeywordsClient);
	    }

	    _createClass(KeywordsClient, [{
	        key: 'loadKeywords',
	        value: function loadKeywords() {
	            return new Promise(function (resolve, reject) {
	                resolve([{ linkId: 1, keywords: 'Adam Bien, react, JEE' }, { linkId: 2, keywords: 'Christopher Batey, docker, JVM, Devoxx Poland 2016' }, { linkId: 3, keywords: 'Chris Hawkes, react, babel, webpack' }]);
	            });
	        }
	    }]);
